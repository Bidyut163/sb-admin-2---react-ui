    ...
    return (
        <div className="container-fluid">
            ...
            <p className="mb-4">
                ...
                official{' '}
                <Link to="https://getbootstrap.com/docs">
                ...
                <div className="col-lg-4">
                    <div className="card shadow mb-4">
                        ...
                        <div className="card-body">
                            ...
                            <p className="text-gray-500 p-3 m-0">
                                .text-gray-500
                            </p>
                            <p className="text-gray-600 p-3 m-0">
                                .text-gray-600
                            </p>
                            <p className="text-gray-700 p-3 m-0">
                                .text-gray-700
                            </p>
                            <p className="text-gray-800 p-3 m-0">
                                .text-gray-800
                            </p>
                            <p className="text-gray-900 p-3 m-0">
                                .text-gray-900
                            </p>
                        </div>
                    </div>
