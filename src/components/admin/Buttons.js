                    ...
                    <div className="card shadow mb-4">
                        ...
                        <div className="card-body">
                            <p>
                                ...
                                package) along with the circle buttons as shown
                    ...
                    <div className="card shadow mb-4">
                        ...
                        <div className="card-body">
                            <p>
                                ...
                                featuring each company's respective brand color.
                                They are used on the user login and registration
                                pages.
                            </p>
                            <p>
                                You can create more custom buttons by adding a
                                new color variable in the
                                <code>_variables.scss</code> file and then using
                                the Bootstrap button variant mixin to create a
                    ...
                    <div className="card shadow mb-4">
                        ...
                        <div className="card-body">
                            <p>
                                ...
                                <code>.btn-icon-split</code> className and the
                                markup in the examples below. The examples below
                                also use the
                                <code>.text-white-50</code> helper className on
                                the icons for additional styling, but it is not
                                required.
                            </p>
                            <Link
                                to="#"
                            ...
                            <p>
                                Also works with small and large button
                                classNamees!
                            </p>
                            <Link
                                to="#"
